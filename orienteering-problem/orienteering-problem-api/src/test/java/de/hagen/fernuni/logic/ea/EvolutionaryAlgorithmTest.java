...
public class EvolutionaryAlgorithmTest {
	...
	public void testSolve() {
		...
		Graph result1 = new EvolutionaryAlgorithm(g1, 99, 20, 10, 5, 0.5, 0).solve();
		...
		Graph result2 = new EvolutionaryAlgorithm(g2, 200, 20, 5, 3, 0.5, 0).solve();

		assertTrue("Evolutionärer Algorithmus konnte alle Knoten hinzufügen", result2.getProfitOfTour() == 450);
